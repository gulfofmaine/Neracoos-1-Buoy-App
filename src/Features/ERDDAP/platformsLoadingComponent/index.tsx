        ...
        if (this.props.platforms.length > 0) {
            ...
            return (
                <Row>
                    <Col>
                        <Alert color="primary">
                            Loading information about platforms from ERDDAP.
                        </Alert>
                    </Col>
                </Row>
            )
            ...
            return (
                <Row>
                    <Col>
                        <Alert color="primary">
                            Trying to load platforms from ERDDAP.
                        </Alert>
                    </Col>
                </Row>
            )
...
export const ErddapPlatformsLoader = connect(mapStateToProps, mapDispatchToProps)(ErddapPlatformsLoaderBase)
