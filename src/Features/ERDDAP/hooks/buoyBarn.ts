...
export function usePlatforms() {
  return useQuery<PlatformFeatureCollection, Error>(BUOY_BARN_PLATFORMS_KEY, getPlatforms, defaultQueryConfig)
}
...
export const BUOY_BARN_FORECAST_KEY = "buoybarn-forecasts-meta"
