...
describe("sea_water_electrical_conductivity conversions", () => {
  it("to imperial", () => {
    const result = sea_water_electrical_conductivity.convertTo(source_value, UnitSystem.imperial)
  ...
  it("display names", () => {
    expect(sea_water_electrical_conductivity.displayName(UnitSystem.imperial)).toBe(displayName)
