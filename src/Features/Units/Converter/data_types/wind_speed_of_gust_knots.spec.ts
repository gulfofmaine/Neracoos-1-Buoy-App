...
describe("wind_speed_of_gust_knots conversions", () => {
  it("to english", () => {
  ...
  it("display names", () => {
    expect(wind_speed_of_gust_knots.displayName(UnitSystem.english)).toBe("kts")
    expect(wind_speed_of_gust_knots.displayName(UnitSystem.metric)).toBe("m/s")
  })
})
