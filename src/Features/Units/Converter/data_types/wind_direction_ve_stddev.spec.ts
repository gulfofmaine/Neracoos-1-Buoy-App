...
describe("wind_direction_ve_stddev conversions", () => {
  it("to imperial", () => {
    const result = wind_direction_ve_stddev.convertTo(source_value, UnitSystem.imperial)
  ...
  it("display names", () => {
    expect(wind_direction_ve_stddev.displayName(UnitSystem.imperial)).toBe("Degrees")
