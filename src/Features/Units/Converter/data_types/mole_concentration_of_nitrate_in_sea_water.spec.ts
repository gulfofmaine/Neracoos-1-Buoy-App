...
describe("mole_concentration_of_nitrate_in_sea_water conversions", () => {
  it("to english", () => {
    const result = mole_concentration_of_nitrate_in_sea_water.convertTo(source_value, UnitSystem.english)
  ...
  it("display names", () => {
    expect(mole_concentration_of_nitrate_in_sea_water.displayName(UnitSystem.english)).toBe(displayName)
