...
describe("wind_direction_uv_stddev conversions", () => {
  it("to imperial", () => {
    const result = wind_direction_uv_stddev.convertTo(source_value, UnitSystem.imperial)
  ...
  it("display names", () => {
    expect(wind_direction_uv_stddev.displayName(UnitSystem.imperial)).toBe("Degrees")
