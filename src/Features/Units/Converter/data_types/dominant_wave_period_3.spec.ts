...
describe("dominant_wave_period_3 conversions", () => {
  it("to imperial", () => {
    const result = dominant_wave_period_3.convertTo(source_value, UnitSystem.imperial)
  ...
  it("display names", () => {
    expect(dominant_wave_period_3.displayName(UnitSystem.imperial)).toBe(displayName)
