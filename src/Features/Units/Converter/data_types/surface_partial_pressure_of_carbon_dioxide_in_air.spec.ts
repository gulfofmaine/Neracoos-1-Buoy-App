...
describe("surface_partial_pressure_of_carbon_dioxide_in_air conversions", () => {
  it("to imperial", () => {
    const result = surface_partial_pressure_of_carbon_dioxide_in_air.convertTo(source_value, UnitSystem.imperial)
  ...
  it("display names", () => {
    expect(surface_partial_pressure_of_carbon_dioxide_in_air.displayName(UnitSystem.imperial)).toBe(displayName)
