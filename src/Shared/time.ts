...
/**
 * Get the current date, but shifted to ISO to remove time zones,
 * and without any hours, minutes, seconds, or miliseconds.
 ...
 */
export const shortIso = (date: Date): string => {
