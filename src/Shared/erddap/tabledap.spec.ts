...
describe('datasetUrl', () => {
    it('Can create a valid URL', () => {
        ...
        expect(result).toEqual("http://www.neracoos.org/erddap/tabledap/N01_aanderaa_all.json?time,current_speed,current_direction&time>=2018-12-15T00:00:00Z")
    })
})
