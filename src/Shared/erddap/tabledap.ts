 ...
 */
export const variableString = (variables: string[]): string => {
 ...
 */
export const tabledapUrl = (server: string, dataset: string, variables: string[], constraints: Constraints): string => {
 ...
 */
export const resultToTimeseries = (result: ErddapJson, variables: string[]): DataTimeSeries[] => {
