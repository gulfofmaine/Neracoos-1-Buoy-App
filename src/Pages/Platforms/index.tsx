 ...
 */
export const PlatformsPage: React.SFC<RouteComponentProps> = ({ location, match }) => {
  const params = urlParams(location.search)

  const platformId = match.params.hasOwnProperty("id") ? (match.params as PlatformMatchParams).id : ""
